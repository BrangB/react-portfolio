  ...
  return (
    <div className="info w-[100%] lg:w-[30%] flex items-center justify-center mb-20 md:mb-28 lg:mb-0">
      <div className="real-info  flex flex-col items-center justify-start px-8 py-20 lg:p-0 w-[100%] lg:w-[80%] bg-white h-[100%] relative rounded-xl">
        ...
        <img
          className="w-[120px] hidden lg:flex avatarImg h-[120px] rounded-sm lg:rounded-lg object-cover relative avatarImg lg:absolute -top-[50px]"
          src={avatar}
          alt=""
        />
        <h2 className="text-[#0B0909] text-3xl lg:text-xl font-bold">
          Brang Tsawm Aung
        </h2>
        ...
        <div className="socialIcon flex w-full items-center justify-center mt-5">
          <a
            href="https://www.facebook.com/share/1DHabsdmRQ/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 lg:w-12 lg:h-12 bg-[#F2F7FC] m-1 hover:scale-110 transition-all duration-200 flex items-center justify-center p-3"
          >
            <i className="fa-brands fa-facebook-f text-blue-600 text-lg md:text-xl"></i>
          </a>
          <a
            href="https://www.instagram.com/brang265?igsh=c2p3YWZuaGI2d3Ns"
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 lg:w-12 lg:h-12 bg-[#F2F7FC] m-1 hover:scale-110 transition-all duration-200 flex items-center justify-center p-3"
          >
            <i className="fa-brands fa-instagram text-orange-700 text-lg md:text-xl"></i>
          </a>
          <a
            href="https://github.com/BrangB"
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 lg:w-12 lg:h-12 bg-[#F2F7FC] m-1 hover:scale-110 transition-all duration-200 flex items-center justify-center p-3"
          >
        ...
        <div className="download absolute bottom-2 flex transition-all duration-200 w-[50px] h-[50px] bg-[#ff9800] rounded-full items-center justify-center">
          <a
            href="/pdf/BrangCV.pdf"
            download="Brang_Tsawm_Aung_Resume.pdf"
            className="flex flex-col items-center text-white"
          >
            <i className="fa-solid fa-download text-white text-lg"></i>
            <p className="absolute text-center text-xs">Download Resume</p>
          </a>
        </div>
      </div>
    </div>
